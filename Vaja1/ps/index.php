...
<body>
    ...
    <div class="container">
        <h1>Professors and Subjects</h1>
        <p>Here you can assign subjects to professors and professors to subjects.</p>
        <hr>
        <form action = "add.php" method = "post">
            <div class="submitForm">
                <div>
                    <label for="Professor">Professor:</label>
                    <select class="submit" id="Professor" name="Professor" required>
                        <?php
                            $sql = "SELECT name, surname, id FROM professor WHERE authority = '1' ORDER BY id DESC";
                            $result = $db->query($sql);
        ...
        <table class="tableAdmin">
            ...
            <?php
                    $sql = "SELECT p.name AS p_name, p.surname AS p_surname, s.name AS s_name, ps.id FROM ps JOIN professor AS p ON p.id = id_professor JOIN subject AS s ON s.id = id_subject ORDER BY id DESC";
                    $result = $db->query($sql);
