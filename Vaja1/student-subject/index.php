...
<body>
    ...
    <div class="container">
            ...
            <div class="submitForm">
                ...
                <label for="Subject">Subject:</label>
                    <select class="submit" id="Subject" name="Subject" required>
                        <?php
                            $sql = "SELECT name, id FROM subject WHERE year = ".$_SESSION["Year"]." AND path = '".$_SESSION["Path"]."' ORDER BY id DESC";
                            $result = $db->query($sql);
        ...
        <table class="tableAdmin">
            ...
            <?php
                    $sql = "SELECT p.name AS p_name, p.surname AS p_surname, s.name AS s_name, ss.id FROM ss JOIN student AS p ON p.id = id_student JOIN subject AS s ON s.id = id_subject WHERE p.id = ".$_SESSION["id"]." ORDER BY id DESC";
                    $result = $db->query($sql);
